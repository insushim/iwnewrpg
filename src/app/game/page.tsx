...
export default function GamePage() {
  ...
  return (
    <main className="relative h-screen overflow-hidden bg-[#040608]">
      ...
      <div className="pointer-events-auto absolute bottom-[100px] left-1 z-10 w-[240px] max-h-[calc(100vh-120px)]">
        <ChatWindow />
      </div>
      ...
      <div className="pointer-events-auto absolute right-1 top-[200px] z-10">
        <InventoryPanel />
      </div>
