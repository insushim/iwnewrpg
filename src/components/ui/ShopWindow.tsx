...
export function ShopWindow() {
  ...
  return (
    <div className="absolute right-4 top-28 z-30 w-[min(96vw,780px)] overflow-hidden rounded-[28px] border border-[#b48a46]/35 bg-[linear-gradient(180deg,rgba(17,21,30,0.96),rgba(6,8,14,0.98))] p-4 shadow-[0_28px_52px_rgba(0,0,0,0.45)]">
...
function ShopColumn({
  ...
  return (
    <div className="rounded-[20px] border border-white/8 bg-[linear-gradient(180deg,rgba(10,13,19,0.86),rgba(16,20,28,0.96))] p-3">
...
function ShopEntry({
  ...
  return (
    <div className="rounded-[16px] border border-white/8 bg-black/22 p-3">
