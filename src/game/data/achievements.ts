...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  },
  {
    ...
    trackType: 'login_streak',
    goal: 7,
    rewards: { exp: 5000, gold: 2000, title: '꾸준한 모험가', itemId: 'mystery_box' },
  },
  {
    id: 'login_14days',
    name: '2주 연속 출석',
    description: '14일 연속 로그인하세요.',
    category: 'social',
    trackType: 'login_streak',
    goal: 14,
    rewards: { exp: 12000, gold: 5000, title: '성실한 수호자' },
  },
  {
    id: 'login_21days',
    name: '3주 철벽 출석',
    description: '21일 연속 로그인하세요.',
    category: 'social',
    trackType: 'login_streak',
    goal: 21,
    rewards: { exp: 25000, gold: 10000, title: '철벽의 수호자', itemId: 'blessing_scroll' },
  },
  {
    id: 'login_28days',
    name: '완벽한 한 달',
    description: '28일 연속 로그인하세요.',
    category: 'social',
    trackType: 'login_streak',
    goal: 28,
    rewards: { exp: 50000, gold: 20000, title: '영원한 수호자', itemId: 'legendary_box' },
    hidden: true,
  },
  {
    id: 'login_60days',
    name: '두 달의 맹세',
    description: '60일 연속 로그인하세요.',
    category: 'social',
    trackType: 'login_streak',
    goal: 60,
    rewards: { exp: 100000, gold: 50000, title: '불멸의 전사' },
    hidden: true,
  },
];
